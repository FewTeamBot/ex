				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						...
						if cmd == "cium":
						  #if msg.from in admin:
							_session = requests.session()
							image = "https://media1.tenor.com/images/0b0545498d2c7e5c36c3ba7dc3814182/tenor.gif?itemid=11757589"
							url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
							headers = {
								"Host": "game.linefriends.com",
								"Content-Type": "application/json",
								...
								"messages": [
									  {
											...
											"template": {
												...
												"columns": [
													{
														"imageUrl": "https://media1.tenor.com/images/0b0545498d2c7e5c36c3ba7dc3814182/tenor.gif?itemid=11757589",
														"action": {
															"type": "uri",
															"uri": "https://line.me/ti/p/~mase-pesek" 
														}
						...
						if cmd == "peluk":
						  #if msg.from in admin:
							_session = requests.session()
							image = "https://media1.tenor.com/images/7ebaeec66f513c2650dda4270441c30e/tenor.gif?itemid=10612044"
							url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
							headers = {
								"Host": "game.linefriends.com",
								"Content-Type": "application/json",
								...
								"messages": [
									  {
											...
											"template": {
												...
												"columns": [
													{
														"imageUrl": "https://media1.tenor.com/images/7ebaeec66f513c2650dda4270441c30e/tenor.gif?itemid=10612044",
														"action": {
															"type": "uri",
															"uri": "https://line.me/ti/p/~mase-pesek" 
														}
						...
						if cmd == "lope":
						  #if msg.from in admin:
							_session = requests.session()
							image = "https://media1.tenor.com/images/e56f8dfc002797cf2d1e9eeb8261ed4b/tenor.gif?itemid=9628038"
							url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
							headers = {
								"Host": "game.linefriends.com",
								"Content-Type": "application/json",
								...
								"messages": [
									  {
											...
											"template": {
												...
												"columns": [
													{
														"imageUrl": "https://media1.tenor.com/images/e56f8dfc002797cf2d1e9eeb8261ed4b/tenor.gif?itemid=9628038",
														"action": {
															"type": "uri",
															"uri": "https://line.me/ti/p/~mase-pesek" 
														}
						...
						if cmd == "malam":
						  #if msg.from in admin:
							_session = requests.session()
							image = "https://media1.tenor.com/images/f5c39ff9dac01465ce7e6af8d39d854e/tenor.gif?itemid=8192910"
							url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
							headers = {
								"Host": "game.linefriends.com",
								"Content-Type": "application/json",
								...
								"messages": [
									  {
											...
											"template": {
												...
												"columns": [
													{
														"imageUrl": "https://media1.tenor.com/images/f5c39ff9dac01465ce7e6af8d39d854e/tenor.gif?itemid=8192910",
														"action": {
															"type": "uri",
															"uri": "https://line.me/ti/p/~mase-pesek" 
														}
						...
						if cmd == "salam":
						  #if msg.from in admin:
							_session = requests.session()
							image = "https://media1.tenor.com/images/70635ec7e6e05bcbb22378312adfb4a2/tenor.gif?itemid=10763056"
							url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
							headers = {
								"Host": "game.linefriends.com",
								"Content-Type": "application/json",
								...
								"messages": [
									  {
											...
											"template": {
												...
												"columns": [
													{
														"imageUrl": "https://media1.tenor.com/images/70635ec7e6e05bcbb22378312adfb4a2/tenor.gif?itemid=10763056",
														"action": {
															"type": "uri",
															"uri": "https://line.me/ti/p/~mase-pesek" 
														}
