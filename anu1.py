				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						...
						if cmd == "sdh":
						  #if msg.from in admin:
							_session = requests.session()
							image = "https://media1.tenor.com/images/07690c0a21778fd3ba919984adca7fcd/tenor.gif?itemid=10798328"
							url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
							headers = {
								"Host": "game.linefriends.com",
								"Content-Type": "application/json",
								...
								"messages": [
									  {
											...
											"template": {
												...
												"columns": [
													{
														"imageUrl": "https://media1.tenor.com/images/07690c0a21778fd3ba919984adca7fcd/tenor.gif?itemid=10798328",
														"action": {
															"type": "uri",
															"uri": "https://line.me/ti/p/~mase-pesek" 
														}
                                                                   ...
                                                                   "contents": {
                                                                       ...
                                                                       "body": {
                                                                               ...
                                                                               "contents": [
                                                                                  ...
                                                                                  {
                                                                                    "type": "text",
                                                                                    "text": " MID:\n {}\n\n member:\n  {}\n\nnama:\n  {}".format(group.id,group.members,group.name),
                                                                                    "wrap": True
                                                                                  }
                                                                               ]
                                                                       },
